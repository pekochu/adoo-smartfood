<?php defined('BASEPATH') OR exit('No direct script access allowed') ?>
					...
					<div class="swiper-slide dark" style="background-image: url('<?=base_url()?>public/images/escom.jpg');">
						<div class="container clearfix">
							<div class="slider-caption slider-caption-center">
								<h2 data-caption-animate="fadeInUp">Bienvenido</h2>
		...
		<section id="content">
				...
				<div class="container clearfix">
					...
					<div class="col_full">
						<ul class="list-group col_two_third">
							...
							<li class="list-group-item">
								Añadimos la página <b>"Casos de uso"</b>, en la sección Diagramas.
								<span class="badge badge-secondary float-right" style="margin-top: 3px;">26/03/2019</span>
							</li>
						</ul>
					</div>					
				</div>
			...
			<div class="content-wrap" style="padding-top:0px">
				<div class="container clearfix">
					<div class="title-block">
						<h1>El <span>equipo</span> de SmartFood</h1>
						<span>Análisis y Diseño Orientado a Objetos - 2CV6</span>
					</div>
					<div class="row">
						<div class="col-lg-6 bottommargin">
							<div class="team team-list clearfix">
								<div class="team-image">
									<img src="<?=base_url()?>public/images/team/marco.jpg" alt="Aguilar Morales Marco Antonio">
								</div>
								<div class="team-desc">
						...
						<div class="col-lg-6 bottommargin">
							<div class="team team-list clearfix">
								<div class="team-image">
									<img src="<?=base_url()?>public/images/team/bravo.jpg" alt="Bravo López Luis Ángel">
								</div>
								<div class="team-desc">
			...
			<div class="content-wrap" style="padding-top:0px">		
				<div class="container clearfix">
					...
					<div class="title-block">
						<h1>Vuelve pronto</h1>
						<span>Iremos agregando contenido conforme pasen los días</span>
					</div>
				</div>
			</div>
		</section>
